...
LOCATION ::= $(notdir $(shell pwd))
deploy:
	git add --all
	git commit --quiet -m "change from 'make deploy'" || echo "no changes"
	git push --quiet
	ssh -t pynq "cd ~/libpynq-5EWC0-2023-v0.2.6/; git pull --quiet origin master; cd applications/${LOCATION}/; make run"
